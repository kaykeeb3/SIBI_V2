...
interface StatsCardProps {
  title: string | (string | React.ReactNode)[]; // Permitindo que seja uma string ou um array de strings/elementos
  count: number;
      ...
      <CardDescription className="flex items-center justify-between">
        <CardTitle className="text-base font-semibold text-gray-800">
          {Array.isArray(title)
            ...
            : title}{" "}
          {/* Verifica se é um array e mapeia ou apenas exibe a string */}
        </CardTitle>
